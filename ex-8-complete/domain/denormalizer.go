...
//virtual workshop ex-8 solution
	case hotelevents.ReservationCanceled:
			d.OnReservationCanceled(v)
	}
	return nil
}
...
//virtual workshop ex-8 solution
func (s *ReservationDenormalizer) OnReservationCanceled(e hotelevents.ReservationCanceled) {
	deleteReservation(s.db, e.Id)
}