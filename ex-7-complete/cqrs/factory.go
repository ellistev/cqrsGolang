...
//virtual workshop ex-7 solution this switch should be implemented to handle CancelReservation command
...
//virtual workshop ex-7 solution this switch should be implemented to handle the event emmited from cancel reservation command
